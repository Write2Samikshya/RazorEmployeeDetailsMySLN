...
{
   public class IEmployeeRepositoryintimpl : IEmployeeRepositoryint
    {

        private List<Employee> _employeeList;

        public IEmployeeRepositoryintimpl()
        {
            _employeeList = new List<Employee>()
            {
                new Employee() { Id = 1, Name = "Mary", Department = Dept.HR,
                    Email = "mary@pragimtech.com", PhotoPath="red.jpg" },
                new Employee() { Id = 2, Name = "John", Department = Dept.IT,
                    Email = "john@pragimtech.com", PhotoPath="multi.jpg" },
                new Employee() { Id = 3, Name = "Sara", Department = Dept.IT,
                    Email = "sara@pragimtech.com", PhotoPath="yellow.jpg" },
        ...
        {
            Employee updatedempvar=_employeeList.FirstOrDefault(e => e.Id == updatedEmployee.Id);

            if(updatedempvar != null)
            {
                updatedempvar.Name = updatedEmployee.Name;
                updatedempvar.Email = updatedEmployee.Email;
                updatedempvar.Department = updatedEmployee.Department;
                updatedempvar.PhotoPath = updatedEmployee.PhotoPath;
            }

            return updatedempvar;
        }
