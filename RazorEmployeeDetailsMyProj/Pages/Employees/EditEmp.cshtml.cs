...
namespace RazorEmployeeDetailsMyProj.Pages.Employees
{
    public class EditEmpModel : PageModel
    {
        ...
        public EditEmpModel(IEmployeeRepositoryint employeeRepositoryint, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult OnGet(int? id)
        {
            if (id.HasValue)
            {
                Employee = employeeRepositoryint.GetEmployee(id.Value);
            }
            else
            {
